...
public interface IBacktestingOrderManagement
{
    ...
    Task<Dictionary<DateTime, List<Order>>> GetOrderHistoryAsync(CancellationToken cancellationToken = default);
    ...
    Task ExecuteOrderAsync(DateTime timestamp, Order order, double executionPrice, double feeRate, CancellationToken cancellationToken);
}
